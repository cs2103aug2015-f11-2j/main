...
public class ViewConstants {
	...
	public static String ERROR_SAVE_NO_LOCATION = "No file location specified";
	public static String ERROR_SAVE_NO_CHANGES = "No changes specified for saving %1$s file location: %2$s";
