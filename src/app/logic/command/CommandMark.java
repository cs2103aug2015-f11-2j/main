...
public class CommandMark extends Command {
	...
	private void logUuidByMarkedTaskCompletion(ArrayList<UUID> markedCompleted,
		...
		if (markedCompleted.size() > 0 && markedUncompleted.size() > 0) {
			LogHelper.getLogger().info(String.format(ViewConstants.MESSAGE_MARK_COMPLETED + "; " + 
			...
			LogHelper.getLogger().info(String.format(ViewConstants.MESSAGE_MARK_UNCOMPLETED,
